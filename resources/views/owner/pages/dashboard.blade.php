                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                  <button type="button" class="bg-gradient-to-tl from-sky-500 to-blue-600 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white viewFB" value="{{ $p->id }}"> Lihat </button>
                                </td>
